...
<template>
  <div class="p-8">
    <div class="mb-8">
      <h1 class="text-[1.75rem] font-bold text-brand-900 mb-1">Моят Профил</h1>
    </div>

    <div class="flex bg-white rounded-xl p-6 border border-brand-100 shadow-sm">
      <!-- Upper summary profile -->
      <div class="flex-1 flex gap-2 items-center content-center">
        <div
    ...
    <div class="mt-8 bg-white rounded-xl p-6 border border-brand-100 shadow-sm">
      <div class="flex justify-between items-center mb-6">
        <h3 class="text-lg font-semibold text-brand-900 mb-4">Лична информация</h3>
        <div>
      ...
      <div class="mt-8">
        ...
        <div class="mt-8 bg-white rounded-xl p-6 border border-brand-100 shadow-sm w-full">
          ...
          <div v-else class="grid grid-cols-2 gap-4">
            ...
            <p v-if="passwordError" class="text-sm text-red-500 col-span-2">
              {{ passwordError }}
            </p>
